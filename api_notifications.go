...
/*
NotificationsApiService Get a list of notifications
 ...
 * @param optional nil or *NotificationsApiNotificationsGetOpts - Optional Parameters:
     * @param "Type_" (optional.String) -  Type of notification to filter on.
     * @param "Offset" (optional.Int32) -  Starting notification record in the result set. Can be used for pagination.
     * @param "Sort" (optional.String) -  Endpoint support multiple sort fields by allowing array of sort params. Sort fields should be applied in the order specified. The sort order for each sort field is ascending unless it is prefixed with a minus (“-“), in which case it will be descending.
     * @param "Limit" (optional.Int32) -  Number of notification records to return. Can be used for pagination.
     * @param "Include" (optional.String) -  Related record types to include in the response.
@return InlineResponse2007
*/

type NotificationsApiNotificationsGetOpts struct {
...
func (a *NotificationsApiService) NotificationsGet(ctx context.Context, evAccessToken string, evApiKey string, localVarOptionals *NotificationsApiNotificationsGetOpts) (InlineResponse2007, *http.Response, error) {
	var (
...
/*
NotificationsApiService Delete a notification
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param evAccessToken Access token required to make the API call.
 * @param id ID of the notification. Use &lt;a href&#x3D;\&quot;#operation/getNotifications\&quot;&gt;getNotifications&lt;/a&gt; if you need to lookup an ID.
 * @param evApiKey API Key required to make the API call.
@return InlineResponse2006
*/
func (a *NotificationsApiService) NotificationsIdDelete(ctx context.Context, evAccessToken string, id int32, evApiKey string) (InlineResponse2006, *http.Response, error) {
	var (
...
/*
NotificationsApiService Get a notification&#x27;s metadata
Returns the specified notification object&#x27;s metadata.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param evAccessToken Access token required to make the API call.
 * @param id ID of the notification. Use &lt;a href&#x3D;\&quot;#operation/getNotifications\&quot;&gt;getNotifications&lt;/a&gt; if you need to lookup an ID.
 * @param evApiKey API Key required to make the API call. 
 * @param optional nil or *NotificationsApiNotificationsIdGetOpts - Optional Parameters:
     * @param "Include" (optional.String) -  Related record types to include in the response.
@return InlineResponse2005
*/

type NotificationsApiNotificationsIdGetOpts struct {
    Include optional.String
}

func (a *NotificationsApiService) NotificationsIdGet(ctx context.Context, evAccessToken string, id int32, evApiKey string, localVarOptionals *NotificationsApiNotificationsIdGetOpts) (InlineResponse2005, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
NotificationsApiService Update a notification
 ...
 * @param evApiKey API Key required to make the API call.
 * @param id ID of the notification. Use &lt;a href&#x3D;\&quot;#operation/getNotifications\&quot;&gt;getNotifications&lt;/a&gt; if you need to lookup an ID.
 * @param optional nil or *NotificationsApiNotificationsIdPatchOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Body4) - 
@return NotificationResponseObject
*/

type NotificationsApiNotificationsIdPatchOpts struct {
    Body optional.Interface
}

func (a *NotificationsApiService) NotificationsIdPatch(ctx context.Context, evAccessToken string, evApiKey string, id int32, localVarOptionals *NotificationsApiNotificationsIdPatchOpts) (NotificationResponseObject, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue NotificationResponseObject
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v NotificationResponseObject
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
NotificationsApiService Create a new notification
 ...
 * @param resource Path to the resource where a notification will be created. 
 * @param optional nil or *NotificationsApiNotificationsPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Body6) - 
@return NotificationResponseObject1
*/

type NotificationsApiNotificationsPostOpts struct {
    Body optional.Interface
}

func (a *NotificationsApiService) NotificationsPost(ctx context.Context, evAccessToken string, evApiKey string, resource string, localVarOptionals *NotificationsApiNotificationsPostOpts) (NotificationResponseObject1, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue NotificationResponseObject1
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 201 {
			var v NotificationResponseObject1
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
NotificationsApiService Unsubscribe an email from a notification
Unsubscribe an email address from a notification. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param evApiKey API key required to make the API call.
 * @param evAccessToken Access Token required to make the API call. 
 * @param optional nil or *NotificationsApiNotificationsUnsubscribePostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Body5) - 

*/

type NotificationsApiNotificationsUnsubscribePostOpts struct {
    Body optional.Interface
}

func (a *NotificationsApiService) NotificationsUnsubscribePost(ctx context.Context, evApiKey string, evAccessToken string, localVarOptionals *NotificationsApiNotificationsUnsubscribePostOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/notifications/unsubscribe"
