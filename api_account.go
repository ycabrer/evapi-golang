...
/*
AccountApiService Get account settings
 ...
 * @param evApiKey Optional if seeking limited info about account, and ev-access-token is provided.
 * @param evAccessToken Optional if seeking limited info about account, and ev-api-key is present
@return InlineResponse20019
*/
func (a *AccountApiService) GetAccount(ctx context.Context, evApiKey string, evAccessToken string) (InlineResponse20019, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param evApiKey ExaVault API Key
 * @param evAccessToken Access token required to make the API call.
 * @param optional nil or *AccountApiPatchAccountOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Body13) -  Update Account Settings
@return AccountPublicResponse
*/

type AccountApiPatchAccountOpts struct {
	Body optional.Interface
}

func (a *AccountApiService) PatchAccount(ctx context.Context, evApiKey string, evAccessToken string, localVarOptionals *AccountApiPatchAccountOpts) (AccountPublicResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Patch")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue AccountPublicResponse
	)
