...
/*
SharesApiService Deactivate a share
...
*/
func (a *SharesApiService) DeleteSharesId(ctx context.Context, evAccessToken string, id int32, evApiKey string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/shares/{id}"
 ...
 * @param optional nil or *SharesApiGetSharesIdOpts - Optional Parameters:
     * @param "Include" (optional.String) -  Comma separated list of relationships to include in response. Possible values are &#x60;owner&#x60;, &#x60;resource&#x60;, &#x60;notifications&#x60;, &#x60;messages&#x60;.
@return InlineResponse20021
*/

type SharesApiGetSharesIdOpts struct {
    Include optional.String
}

func (a *SharesApiService) GetSharesId(ctx context.Context, evApiKey string, evAccessToken string, id int32, localVarOptionals *SharesApiGetSharesIdOpts) (InlineResponse20021, *http.Response, error) {
	var (
 ...
 * @param evAccessToken Access Token
 * @param id PLACEHOLDER
@return RegularShareResponse1
*/
func (a *SharesApiService) PatchSharesId(ctx context.Context, body Body16, evApiKey string, evAccessToken string, id int32) (RegularShareResponse1, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue RegularShareResponse1
	)
...
/*
SharesApiService Creates a share
 ...
 * @param evAccessToken Access token required to make the API call.
 * @param evApiKey API Key required to make the API call.
 * @param optional nil or *SharesApiPostSharesOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Body15) - 
@return RegularShareResponse
*/

type SharesApiPostSharesOpts struct {
    Body optional.Interface
}

func (a *SharesApiService) PostShares(ctx context.Context, evAccessToken string, evApiKey string, localVarOptionals *SharesApiPostSharesOpts) (RegularShareResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue RegularShareResponse
	)
...
/*
SharesApiService Complete send files
After uploading the files to be sent, use this method to trigger invitation emails and finish the send files setup.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param evApiKey API Key
 * @param evAccessToken Access Token
 * @param id PLACEHOLDER
@return RegularShareResponse2
*/
func (a *SharesApiService) PostSharesCompleteSendId(ctx context.Context, evApiKey string, evAccessToken string, id int32) (RegularShareResponse2, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue RegularShareResponse2
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/shares/complete-send/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
