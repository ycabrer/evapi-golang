...
/*
ShareApiService Get a list of shares
 ...
 * @param optional nil or *ShareApiGetSharesOpts - Optional Parameters:
     * @param "Hash" (optional.String) -  Returns single share by hash
     ...
     * @param "Scope" (optional.String) -  PLACEHOLDER
     * @param "Sort" (optional.String) -  PLACEHOLDER
     * @param "Type_" (optional.String) -  Filter shares by type
     * @param "Include" (optional.String) -  Comma separated list of relationships to include in response. Possible values are &#x60;owner&#x60;, &#x60;resource&#x60;, &#x60;notifications&#x60;, &#x60;messages&#x60;, &#x60;activity&#x60;.
     * @param "Path" (optional.String) -  Path expression to filter shares by
@return InlineResponse20020
*/

type ShareApiGetSharesOpts struct {
...
func (a *ShareApiService) GetShares(ctx context.Context, evAccessToken string, evApiKey string, localVarOptionals *ShareApiGetSharesOpts) (InlineResponse20020, *http.Response, error) {
	var (
