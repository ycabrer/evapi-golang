...
func (a *UsersApiService) CreateUser(ctx context.Context, evAccessToken string, evApiKey string, localVarOptionals *UsersApiCreateUserOpts) (UserResponseObject, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue UserResponseObject
	)
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param evAccessToken Access token required to make the API call.
 * @param id The user&#x27;s ID. Note that this is our internal ID, and _not the username_. You can obtain it by calling the &lt;a href&#x3D;\&quot;#operation/getUser\&quot;&gt;getUser&lt;/a&gt; method.
 * @param evApiKey API key required to make the API call.
@return InlineResponse20010
*/
func (a *UsersApiService) DeleteUser(ctx context.Context, evAccessToken string, id int32, evApiKey string) (InlineResponse20010, *http.Response, error) {
	var (
...
/*
UsersApiService Get info for a user
 ...
 * @param optional nil or *UsersApiGetUserOpts - Optional Parameters:
     * @param "Include" (optional.String) -  Comma-separated list of relationships to include in response. Possible values include &#x60;homeResource&#x60; and &#x60;ownerAccount&#x60;.
...
func (a *UsersApiService) GetUser(ctx context.Context, evAccessToken string, id int32, evApiKey string, localVarOptionals *UsersApiGetUserOpts) (InlineResponse2009, *http.Response, error) {
	var (
...
/*
UsersApiService Get a list of users
 ...
 * @param optional nil or *UsersApiGetUsersOpts - Optional Parameters:
     ...
     * @param "Offset" (optional.Int32) -  Starting user record in the result set. Can be used for pagination.
     ...
     * @param "Limit" (optional.Int32) -  Number of users to return. Can be used for pagination.
     * @param "Include" (optional.String) -  Comma separated list of relationships to include in response. Possible values are &#x60;resource&#x60;, &#x60;account&#x60;.
...
func (a *UsersApiService) GetUsers(ctx context.Context, evAccessToken string, evApiKey string, localVarOptionals *UsersApiGetUsersOpts) (InlineResponse2008, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *UsersApiService) UpdateUser(ctx context.Context, evAccessToken string, evApiKey string, id int32, localVarOptionals *UsersApiUpdateUserOpts) (InlineResponse20011, *http.Response, error) {
	var (
