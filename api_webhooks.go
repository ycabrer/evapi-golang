...
/*
WebhooksApiService Get webhook logs
 ...
 * @param optional nil or *WebhooksApiGetWebhookLogsOpts - Optional Parameters:
...
type WebhooksApiGetWebhookLogsOpts struct {
...
func (a *WebhooksApiService) GetWebhookLogs(ctx context.Context, evApiKey string, evAccessToken string, localVarOptionals *WebhooksApiGetWebhookLogsOpts) (WebhooksActivityResponse, *http.Response, error) {
	var (
