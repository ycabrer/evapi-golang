...
/*
EmailApiService Send referral email to a given address
 ...
 * @param optional nil or *EmailApiPostEmailReferralOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Body14) -
@return InlineResponse2014
*/

type EmailApiPostEmailReferralOpts struct {
	Body optional.Interface
}

func (a *EmailApiService) PostEmailReferral(ctx context.Context, evAccessToken string, evApiKey string, localVarOptionals *EmailApiPostEmailReferralOpts) (InlineResponse2014, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/email/referral"
...
/*
EmailApiService Resend welcome email to specific user
Resend the initial welcome email to specific user.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param evAccessToken Access token required to make the API call.
 * @param username A username to send welcome email to
 * @param evApiKey API Key required to make the API call.
@return InlineResponse2014
*/
func (a *EmailApiService) PostEmailWelcomeUsername(ctx context.Context, evAccessToken string, username string, evApiKey string) (InlineResponse2014, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/email/welcome/{username}"
