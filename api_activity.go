...
/*
ActivityApiService Get activity logs
 ...
 * @param optional nil or *ActivityApiGetActivityLogsOpts - Optional Parameters:
     * @param "Offset" (optional.Int32) -  Offset of the records list
     * @param "Limit" (optional.Int32) -  Limit of the records list
     * @param "UserName" (optional.String) -  Username used for filtering a list
     * @param "Path" (optional.String) -  Path used to filter records
     * @param "IpAddress" (optional.String) -  Used to filter session logs by ip address
     * @param "Type_" (optional.String) -  Filter session logs for operation type
     * @param "StartDate" (optional.String) -  Start date of the filter data range
     * @param "EndDate" (optional.String) -  End date of the filter data range
     * @param "Sort" (optional.String) -  Comma separated list sort params
@return SessionActivityResponse
*/

type ActivityApiGetActivityLogsOpts struct {
...
func (a *ActivityApiService) GetActivityLogs(ctx context.Context, evApiKey string, evAccessToken string, localVarOptionals *ActivityApiGetActivityLogsOpts) (SessionActivityResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue SessionActivityResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/activity/session"
...
/*
ActivityApiService Get webhook logs
 ...
 * @param evApiKey API Key
 * @param evAccessToken Access Token
 * @param optional nil or *ActivityApiGetWebhookLogsOpts - Optional Parameters:
     * @param "Offset" (optional.Int32) -  Records to skip before returning results
     * @param "Limit" (optional.Int32) -  Limit of the records list
     * @param "Path" (optional.String) -  Path used to filter records
     * @param "StatusCode" (optional.Int32) -  Filter by webhook response status code
     * @param "Event" (optional.String) -  Filter by triggered event
     * @param "Sort" (optional.String) -  Comma separated list sort params
     * @param "Username" (optional.String) -  Filter by triggering username
@return WebhooksActivityResponse
*/

type ActivityApiGetWebhookLogsOpts struct {
    Offset optional.Int32
    Limit optional.Int32
    Path optional.String
...
func (a *ActivityApiService) GetWebhookLogs(ctx context.Context, evApiKey string, evAccessToken string, localVarOptionals *ActivityApiGetWebhookLogsOpts) (WebhooksActivityResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue WebhooksActivityResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/activity/webhooks"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v WebhooksActivityResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
