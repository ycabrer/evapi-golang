...
type EmailListsApiService service
/*
EmailListsApiService Delete an email list with given id
...
*/
func (a *EmailListsApiService) DeleteEmailList(ctx context.Context, evAccessToken string, id string, evApiKey string) (InlineResponse2001, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/email-lists/{id}"
...
/*
EmailListsApiService Get all email groups
 ...
 * @param evAccessToken Access token required to make the API call.
 * @param evApiKey API Key required to make the API call.
 * @param optional nil or *EmailListsApiGetEmailListsOpts - Optional Parameters:
     * @param "Include" (optional.String) -  Related record types to include in the response.
@return InlineResponse200
*/

type EmailListsApiGetEmailListsOpts struct {
    Include optional.String
}

func (a *EmailListsApiService) GetEmailLists(ctx context.Context, evAccessToken string, evApiKey string, localVarOptionals *EmailListsApiGetEmailListsOpts) (InlineResponse200, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/email-lists"
...
/*
EmailListsApiService Get individual email list
Retrieve all the metadata tied to a specific email list. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param evAccessToken Access token required to make the API call.
 * @param id Form id
 * @param evApiKey API Key required to make the API call.
@return EmailListResponse1
*/
func (a *EmailListsApiService) GetEmailListsId(ctx context.Context, evAccessToken string, id string, evApiKey string) (EmailListResponse1, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue EmailListResponse1
	)
...
/*
EmailListsApiService Update an email list
 ...
 * @param evApiKey API Key required to make the API call. 
 * @param id Form id
 * @param optional nil or *EmailListsApiPatchEmailListOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Body1) - 
@return EmailListsResponse2
*/

type EmailListsApiPatchEmailListOpts struct {
    Body optional.Interface
}

func (a *EmailListsApiService) PatchEmailList(ctx context.Context, evAccessToken string, evApiKey string, id string, localVarOptionals *EmailListsApiPatchEmailListOpts) (EmailListsResponse2, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue EmailListsResponse2
	)
...
/*
EmailListsApiService Create new email list
 ...
 * @param evAccessToken Access token required to make the API call.
 * @param evApiKey API Key required to make the API call.
 * @param optional nil or *EmailListsApiPostEmailListsOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Body) - 
@return EmailListsResponse1
*/

type EmailListsApiPostEmailListsOpts struct {
    Body optional.Interface
}

func (a *EmailListsApiService) PostEmailLists(ctx context.Context, evAccessToken string, evApiKey string, localVarOptionals *EmailListsApiPostEmailListsOpts) (EmailListsResponse1, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue EmailListsResponse1
	)
