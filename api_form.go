...
/*
FormApiService Add a form submission
 ...
 * @param entryId Id of the entry to associate a node with
 * @param nodeId Id of the node to be associated with an entry
 * @param shareHash Hash of a share that owns current form
@return InlineResponse2011
*/
func (a *FormApiService) AddFormMessage(ctx context.Context, evApiKey string, evAccessToken string, entryId string, nodeId string, shareHash string) (InlineResponse2011, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/forms/entries/{shareHash}/{entryId}/{nodeId}"
	...
	localVarPath = strings.Replace(localVarPath, "{"+"shareHash"+"}", fmt.Sprintf("%v", shareHash), -1)
...
/*
FormApiService Add user data to a form
 ...
 * @param shareHash Hash of a receive that related to a given form
 * @param optional nil or *FormApiFormEntriesOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Body3) - 
@return InlineResponse201
*/

type FormApiFormEntriesOpts struct {
    Body optional.Interface
}

func (a *FormApiService) FormEntries(ctx context.Context, evApiKey string, shareHash string, localVarOptionals *FormApiFormEntriesOpts) (InlineResponse201, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/forms/{shareHash}/entries"
	localVarPath = strings.Replace(localVarPath, "{"+"shareHash"+"}", fmt.Sprintf("%v", shareHash), -1)
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param evApiKey API key required to make the API call.
 * @param id Id of the entry to be completed
@return InlineResponse2004
*/
func (a *FormApiService) FormsEntriesCompleteEntryIdPost(ctx context.Context, evApiKey string, id string) (InlineResponse2004, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/forms/entries/complete-entry/{id}"
...
*/
func (a *FormApiService) FormsEntriesIdDelete(ctx context.Context, evAccessToken string, id string, evApiKey string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/forms/entries/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
 ...
 * @param formId
 * @param evApiKey API Key required to make the API call. 
 * @param optional nil or *FormApiFormsEntriesIdGetOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  Limit of records to be returned (for pagination)
     * @param "Offset" (optional.Int32) -  Current offset of records (for pagination)
@return FormDataResponse
*/

type FormApiFormsEntriesIdGetOpts struct {
    Limit optional.Int32
    Offset optional.Int32
}

func (a *FormApiService) FormsEntriesIdGet(ctx context.Context, evAccessToken string, formId string, evApiKey string, localVarOptionals *FormApiFormsEntriesIdGetOpts) (FormDataResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/forms/entries/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"formId"+"}", fmt.Sprintf("%v", formId), -1)
...
/*
FormApiService Get form data for a receive folder
Returns the details of the form assigned to a receive folder. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param evApiKey API key required to make the API call.
 * @param shareHash Share hash to retrieve the form for.
 * @param evAccessToken Access Token required to make the API call.
 * @param optional nil or *FormApiGetFormsOpts - Optional Parameters:
     * @param "Include" (optional.String) -  Related record types to include in the response.
@return InlineResponse2002
*/

type FormApiGetFormsOpts struct {
    Include optional.String
}

func (a *FormApiService) GetForms(ctx context.Context, evApiKey string, shareHash string, evAccessToken string, localVarOptionals *FormApiGetFormsOpts) (InlineResponse2002, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	localVarQueryParams.Add("shareHash", parameterToString(shareHash, ""))
...
/*
FormApiService Get form details
Returns the details of the designated from on a receive folder. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param evApiKey API key required to make the API call.
 * @param id Form ID to retrieve the setup for
 * @param evAccessToken Access Token required to make the API call.
 * @param optional nil or *FormApiGetFormsIdOpts - Optional Parameters:
     * @param "Include" (optional.String) -  Related record types to include in the response.
@return InlineResponse2003
*/

type FormApiGetFormsIdOpts struct {
    Include optional.String
}

func (a *FormApiService) GetFormsId(ctx context.Context, evApiKey string, id int32, evAccessToken string, localVarOptionals *FormApiGetFormsIdOpts) (InlineResponse2003, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/forms/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
FormApiService Updates a form with given parameters
 ...
 * @param evApiKey API Key required to make the API call.
 * @param id Form id
 * @param optional nil or *FormApiUpdateFormOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Body2) - 
@return RegularFormResponse
*/

type FormApiUpdateFormOpts struct {
    Body optional.Interface
}

func (a *FormApiService) UpdateForm(ctx context.Context, evAccessToken string, evApiKey string, id string, localVarOptionals *FormApiUpdateFormOpts) (RegularFormResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue RegularFormResponse
	)
