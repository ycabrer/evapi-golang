...
type RecipientsApiService service
/*
RecipientsApiService Delete a share recipient from all shares
 ...
 * @param email PLACEHOLDER
 * @param evApiKey API Key required to make the API call.
@return InlineResponse20023
*/
func (a *RecipientsApiService) DeleteRecipientsSharesEmail(ctx context.Context, evAccessToken string, email string, evApiKey string) (InlineResponse20023, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/recipients/shares/{email}"
...
/*
RecipientsApiService Delete a share recipient from a single share
Delete a share recipient from a single share they&#x27;ve been invited to. This will not delete any files or folders. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param evAccessToken Access token required to make the API call.
 * @param shareId PLACEHOLDER
 * @param email PLACEHOLDER
 * @param evApiKey API Key required to make the API call.
@return InlineResponse20023
*/
func (a *RecipientsApiService) DeleteRecipientsSharesShareIdEmail(ctx context.Context, evAccessToken string, shareId int32, email string, evApiKey string) (InlineResponse20023, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/recipients/shares/{shareId}/{email}"
	localVarPath = strings.Replace(localVarPath, "{"+"shareId"+"}", fmt.Sprintf("%v", shareId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"email"+"}", fmt.Sprintf("%v", email), -1)
...
/*
RecipientsApiService Get share recipient emails
...
*/
func (a *RecipientsApiService) GetRecipients(ctx context.Context, evAccessToken string, evApiKey string) (InlineResponse20022, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/recipients"
...
/*
RecipientsApiService Resend invitations to share recipients
...
*/
func (a *RecipientsApiService) PostRecipientsSharesInvitesShareId(ctx context.Context, evAccessToken string, shareId int32, evApiKey string) (InlineResponse2015, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/recipients/shares/invites/{shareId}"
	localVarPath = strings.Replace(localVarPath, "{"+"shareId"+"}", fmt.Sprintf("%v", shareId), -1)
